...
### 2.1 Command to delete all stages or any partial stage (Pull request accepted #881 )
...
### 2.2 Changes in Global Routing source code to decrease CPU usage time 
...
![Grid.cpp before editing](images/before.png)

After:

![Grid.cpp after editing](images/after.png)
...
### 2.3 RTL to GDSII flow for AMBA APB Communication Protocol 
